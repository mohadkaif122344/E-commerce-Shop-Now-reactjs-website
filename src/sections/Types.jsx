...
const Types = () => {
  ...
  return (
    <div className="w-full lg:px-20 px-5 py-[80px] grid lg:grid-cols-3 grid-cols-1 justify-center items-start gap-10">
      ...
      >
        <h1 className="text-themeyello border rounded-lg border-themeyello px-6 py-2 text-lg">
          60% Off
        </h1>
        <h1 className="text-4xl text-end text-white font-semibold">
          Wireless <br /> Devices
        </h1>
        <button className="bg-themeyello px-6 py-3 rounded-lg text-black font-semibold">
          SHOP NOW
        </button>
      </div>
